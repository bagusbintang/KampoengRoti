...
class InvoiceModel {
  ...
  InvoiceModel.fromJson(Map<String, dynamic> inJson) {
    ...
    iHeaderPromoDisc = double.parse(inJson['iheader_promodiscount'].toString());
    iHeaderMemberDisc =
        double.parse(inJson['iheader_memberdiscount'].toString());
    iHeaderTotal = double.parse(inJson['iheader_total'].toString());
    iHeaderGrandTotal = double.parse(inJson['iheader_grandtotal'].toString());
